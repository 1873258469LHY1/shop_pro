  ...
  <div class="rankListContainer">
    <div class="rec-title">
      <div class="rec-title-nav">
        <router-link to="/" class="rec-bar">推荐</router-link>
        <router-link to="/ranklist" class="rec-bar" active>排行榜</router-link>
    ...
    <div class="rankList">
        ...
        <el-card>
          ...
          <ul>
            <li class="navItem active">
              <img src="https://img3.kuwo.cn/star/upload/5/6/1609800091.png" />
              <div class="navContainer">
                <span class="name">酷我飙升榜</span>
                <span class="time">今日更新</span>
              </div>
            </li>
            <li class="navItem">
              <img src="https://img3.kuwo.cn/star/upload/5/6/1609800091.png" />
      ...
      <div class="rankDetail">
        <div>
          <h3 class="title">酷我飙升榜</h3>
          <span class="update-time">更新时间: 2021-01-05</span>
        </div>
        <div class="btns">
